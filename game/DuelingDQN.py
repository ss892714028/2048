...
class DQNAgent:
    ...
    def __init__(self, state_size=[1, 4, 4, 1], epsilon=0, gamma=0.9, epsilon_decay=0,
                 epsilon_min=0, learning_rate=0.0001, action_space=4, c=150):
    ...
    def build(self):
        ...
        model.compile(loss=self.loss, optimizer=Adam(lr=0.000001),metrics=['accuracy'])
...
if __name__ == "__main__":
    ...
    for i in range(episodes):
        ...
        while True:
            ...
            reward = g.gained_score/g.board.mean()
